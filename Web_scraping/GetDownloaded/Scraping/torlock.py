...
# print(p,list)
    ...
    urlrr = 'https://www.torlock.com/'
    # https://1337x.gd/search/call+of+duty/1/
    start_urls = [urlrr,
                  ]

    def parse(self):
        return scrapy.Request(url=self.urlrr, callback=self.parser, headers={"User-Agent": "Mozilla/5.0 (Linux; Android 7.0; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/60.0.3112.107 Mobile Safari/537.36"},
                              meta={"proxy": "http://157.245.109.242"})
